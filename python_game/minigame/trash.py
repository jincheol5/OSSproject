...
class Trash:
    ...
    def new(self,ID):
        ...
        self.object_group = pygame.sprite.Group() # 오프젝트 그룹
        self.player_button_group = pygame.sprite.Group() # 버튼 그룹
        self.player_button = []
    ...
    def update(self):
        ...
        # life 감소 (object 가 바닥에 닿음)
        self.miss = pygame.sprite.spritecollide(self.bottom, self.object_group, True, pygame.sprite.collide_mask)
        if self.miss:
            self.life -= 1
    ...
    def hit(self, index):
        ...
        self.hitted = pygame.sprite.spritecollide(self.player_button[index], self.object_group, True, pygame.sprite.collide_mask)
        if (self.hitted):
            self.score += 10