...
class Startpage:
    def __init__(self, name, explain, score, key, exit):
        ...
        self.text3 = Text(WIDTH/2,270, score, 20, WHITE, MOVIE)
        self.text4 = Text(WIDTH/2,340, key, 20, WHITE, MOVIE)
        self.text5 = Text(WIDTH/2,410, exit, 20, WHITE, MOVIE)
        self.startButtonText = Text(WIDTH/2, HEIGHT*4/5, "P L A Y", 40, BLACK, MOVIE)
        self.text_group = pygame.sprite.Group()
        self.text_group.add(self.text1)
        self.text_group.add(self.text2)
        self.text_group.add(self.text3)
